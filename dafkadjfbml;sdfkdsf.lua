...
loadstring([[
    ...
    local Args = {...}
    if Method == 'FireServer' and self.Name == 'RemoteEvent' and env.psskill and (env.Options["Auto Mastery"].Value or env.Options["Auto Sea Event"].Value or env.Options["Auto Trial"].Value or env.Options["Auto Attack Leviathan"].Value) then
...
function ToggleNoclip()
    ...
    or Options["Auto Upgrade Sword Inventory"].Value then
        return true 
    end
end
