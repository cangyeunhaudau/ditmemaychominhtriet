...
function ToggleNoclip()
    ...
    or Options["Teleport Player"].Value then
        return true 
    end
end
...
Tabs.SeabeastTab:AddDropdown("Select Player Teleport", {
    Title = "Select Player Teleport",
    Values = DetectNamePlayer(),
    Multi = false,
    Default = Settings["Select Player Teleport"] or "",
    Callback = function(value)
        SaveSettings("Select Player Teleport",value)
    end
})
Tabs.SeabeastTab:AddButton({
    ...
    Description = "",
    Callback = function()
        Options["Select Player Teleport"]:SetValues(DetectNamePlayer())
    end
})

Tabs.SeabeastTab:AddToggle("Teleport Player", {
...
function TeleportPlayer()
    for i,v in pairs(game:GetService("Players"):GetChildren()) do
        if v.Name == Options["Select Player Teleport"].Value  then 
            return v 
        end
    end
end
